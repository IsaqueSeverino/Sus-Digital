document.addEventListener("DOMContentLoaded", () => {
    ...
    horariosContainer.addEventListener("click", (event) => {
        if (event.target.classList.contains("btn-horario") && !event.target.disabled) {
            const todosOsBotoes = horariosContainer.querySelectorAll(".btn-horario");
    ...
    btnConfirmar.addEventListener("click", () => {
        ...
        const agendamentoAtual = { hospital: hospitalSelect.value, data: dataInput.value, horario: horarioSelecionado };
